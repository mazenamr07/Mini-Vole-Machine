...
//    Hexadecimal
int ALU::hexToDec(const std::string &hex, bool isTwosComplement, bool isFloatNotation) {
...
std::string ALU::decToHex(int dec, bool isTwosComplement, bool isFloatNotation) {
    if (!isTwosComplement && !isFloatNotation) {
